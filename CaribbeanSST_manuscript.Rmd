...
ggarrange(had_month_plot, had_year_plot, ncol = 1, labels = c("A", "B"), align = "hv")
  ...
  ggsave("figures/Manuscript/Fig2_SST_trends.png", width = 6, height = 7.5)
...
anim_save("HadISST_twitter_presentations.gif", animation = last_animation())
