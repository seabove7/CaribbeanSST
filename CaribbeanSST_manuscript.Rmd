...
data_brick2[sapply(data_brick2, is.infinite)] <- NA
...
gls.fun2 <- function(x, time){
  if(is.na(x)){NA} # this removes any NA pixels from the slope calculations 
  else{
...
raster_slope2 <- calc(data_brick2, function(x) gls.fun2(x, time = time)) # function applied here
