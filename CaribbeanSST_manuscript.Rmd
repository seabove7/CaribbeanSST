...
ggplot() +
  ...
  geom_line(data = had_predict_df, aes(x=year, y=response)) +
  geom_line(data = had_gam_slope, aes(x = year, y = value, colour = type), lwd = 0.75) +
  scale_colour_manual(values = c("#4575b4", "#d73027")) +
  coord_cartesian(xlim = c(1870, 2020))  +
  ggsave("figures/Supplemental_figs/FigS2_HadISST_GAM_slopes.pdf", width = 6, height = 3.75)
...
plot_grid(path_month_plot, path_year_plot, ncol = 1, labels = c("A", "B"), align = "hv") +
  ggsave("figures/Supplemental_figs/FigS3_Pathfinder_SST_trends.pdf", width = 6, height = 7.5)
...
combo_plot <- ggplot() +
  ...
  scale_y_continuous(breaks = seq(24, 30, 1)) +
  coord_cartesian(xlim = c(1870, 2020)) +
  ggsave("figures/Supplemental_figs/FigS4_Both_SST_trends.pdf", width = 6, height = 4)
...
FigureS5 <- cowplot::plot_grid(path_pval_map, map_p, align = "hv", labels = c("A", "B")) +
  ggsave("figures/Supplemental_figs/FigS6_SST_MHW_significance_map.pdf", width = 14.5, height = 5)
...
plot_grid(had_map, had_pval_map, labels = c("A", "B")) +
  ggsave("figures/Supplemental_figs/FigS7_HadISST_map.pdf", width = 14, height = 5)
...
plot_grid(had_map_sub, had_pval_map_sub, labels = c("A", "B")) +
  ggsave("figures/Supplemental_figs/FigS8_HadISST_subset_map.pdf", width = 14, height = 5)
