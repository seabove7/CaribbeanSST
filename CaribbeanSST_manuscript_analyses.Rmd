...
ecoregion_warm_year <- data.frame(ecoregion = region_names,
                                  warm_year = c(1986, 1985, 1979, 1986, 1975, 1979, 1981, 1993))

ecoregion_sst <- ecoregion_sst %>% 
...
for (region in 1:length(region_names)) {
  ...
  ecoregion_subset <- subset(ecoregion_sst, ecoregion == ecoregion_warm_year[region, 1])
