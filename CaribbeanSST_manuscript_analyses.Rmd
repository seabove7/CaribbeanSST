...
map_slope <- ggplot(OISST_nTrend_carib, aes(x = lon, y = lat)) + 
  ...
  ggtitle("MHW slope from 1981 to 2017")
...
map_p <- ggplot(OISST_nTrend_carib, aes(x = lon, y = lat)) + 
  ...
  coord_sf(xlim = c(-100,-55), ylim = c(7.65,33), expand = FALSE) +
  labs(x = "", y = "") +
  ggtitle("MHW significance from 1981 to 2017")
...
bound_df <- data.frame("lon" = c(262.125, 285.125, 285.125, 302.125, 302.125, 285.125, 285.125, 276.125, 276.125, 271.125, 269.625, 262.125,262.125),
                       "lat" = c(30.125, 30.125, 25.125, 25.125, 9.125, 9.125, 7.375, 7.375, 15.875, 15.875, 17.875, 17.875, 30.125))
...
load("/Users/colleen/Dropbox/Git/CaribbeanSST/data/Pathfinder/Pathfinder_slope.Rdata") # load Rdata of the modified Pathfinder raster
...
path_pavl <- read.csv("/Users/colleen/Dropbox/Git/CaribbeanSST/data/Pathfinder/Pathfinder_pval.csv", header = TRUE) # read in the saved .csv of the dataframe
...
path_pval_map <- ggplot() +  
  ...
  coord_sf(xlim = c(-100,-55), ylim = c(7.65,33), expand = FALSE) +
  labs(x = "", y = "") +
  ggtitle("SST slope significance from 1981 to 2019 (Pathfinder)")
...
cowplot::plot_grid(path_map, map_slope, labels = c("A", "B"), label_size = 18) +
  ggsave("/Users/colleen/Dropbox/SST_Caribbean_Manuscript/Working Sections/Figures/Fig5_SST_MHW_map.pdf", width = 14.5, height = 5)

## Combined Figure 5 p values:
cowplot::plot_grid(path_pval_map, map_p, align = "hv") +
  ggsave("/Users/colleen/Dropbox/SST_Caribbean_Manuscript/Working Sections/Figures/SST_MHW_significance_map.pdf", width = 14.5, height = 5)
