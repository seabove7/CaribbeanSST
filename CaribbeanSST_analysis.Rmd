...
Antillies_ecoreg <- ecoregions2[ecoregions2@data$ECOREGION == "Greater Antilles", ]
...
Antillies_reefs <- shapes[Antillies_ecoreg,]
...
eco_reef_map <- ggplot() +
    ...
    geom_point(data = Antillies_reefs, aes(x=long, y = lat, group = group), fill = "#E7298A", color='#E7298A', size = 0.2) +
...
#    geom_polygon(data = Antillies_reefs, aes(x=long, y = lat, group = group), fill = "#E7298A", color='#E7298A', lwd = 0.1) +
