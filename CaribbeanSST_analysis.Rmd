...
Pathfinder_monthly_edit_path <- "/Users/colleen/Dropbox/Git/Data_Not_On_Git/CaribbeanSST_data/Pathfinder_monthly_edit.nc"
...
combo_plot <- ggplot() +
  ...
  geom_smooth(data = HADI_year_avg[-151,], method = "gam", aes(x = year, y = mean), colour = "darkgrey", group = 1, size = 1, se = FALSE, alpha = 0.5) + # smoothed mean temp
