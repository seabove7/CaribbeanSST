...
# install.packages("sf", "ncdf4", "raster", "maptools", "rgdal", "ggplot2", "tidyverse", "xts", "RColorBrewer", "tidyr", "dplyr", "fields", "gganimate", "sp", "plotly", "grDevices", "repmis", "binr", "cowplot")
...
had_pval_map <- ggplot() +  
  ...
  ggsave("figures/HadISST_pval_map_knit.pdf", width = 8, height = 5)
...
plot_grid(had_map, had_pval_map, labels = c("A", "B")) +
  ggsave("figures/Fig6_HadISST_map_knit.pdf", width = 14, height = 5)
...
had_pval_map_sub <- ggplot() +  
  ...
  xlab("Longitude") +
  ggtitle(paste0("SST slope significance")) + 
  ggsave("figures/HadISST_pval_subset_map_knit.pdf", width = 8, height = 5)
...
plot_grid(had_map_sub, had_pval_map_sub, labels = c("A", "B")) +
  ggsave("figures/Fig7_HadISST_subset_map_knit.pdf", width = 14, height = 5)
...
path_map <- ggplot() +  
  ...
  ggsave("figures/Pathfinder_map.pdf", width = 8, height = 5)
...
path_pval_map <- ggplot() +  
  ...
  xlab("Longitude") +
  ggtitle(paste0("SST slope significance")) + 
  ggsave("figures/Pathfinder_pval_map.pdf", width = 8, height = 5)
...
##### Full HadISST max temp raster layer
...
#had_max_yr <- as.data.frame(as(raster_max_yr, "SpatialPixelsDataFrame")) # convert to a raster to dataframe
#colnames(had_max_yr) <- c("year", "x", "y")

```

```{r had max SST map, message=FALSE, warning=FALSE, fig.align='center'}
...
had_max_plot <- ggplot() +  
  ...
  ylab("Latitude") +
  xlab("Longitude") +
  ggtitle(paste0("Maximum recorded SST between ", format.Date(start_date, "%Y"), " and ", format.Date(end_date, "%Y")," (HadISST)")) 
had_max_plot
...
#  theme_bw() +
#  theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(), panel.background=element_blank(), strip.background = element_blank(), panel.border = element_rect(colour = "black", fill = NA, size = 1), legend.position = "bottom") +
#  geom_raster(data = had_max_yr, aes(x = x, y = y, fill = year), alpha=0.8, interpolate = TRUE) + 
...
#plot_grid(had_max_plot, had_max_year_plot, labels = c("A", "B")) +
...
##### 1981 - 2019 subset HadISST max temp raster layer

## create raster layer of the max SST per pixel
...
## convert the raster of observational year to a df for plotting
#had_max_yr_sub <- as.data.frame(as(raster_max_yr_sub, "SpatialPixelsDataFrame")) # convert to a raster to dataframe
#colnames(had_max_yr_sub) <- c("year", "x", "y")

```

```{r had max subset SST map, message=FALSE, warning=FALSE, fig.align='center'}
# , fig.width=12, fig.height=6
...
had_max_subset_plot <- ggplot() +  
  ...
  ylab("Latitude") +
  xlab("Longitude") +
  ggtitle(paste0("Maximum recorded SST between ", format.Date(start_dateb, "%Y"), " and ", format.Date(end_date, "%Y")," (HadISST)")) 
had_max_subset_plot


### Plot the year of the max SST
#had_max_year_subset_plot <- ggplot() +  
#  theme_bw() +
#  theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(), panel.background=element_blank(), strip.background = element_blank(), panel.border = element_rect(colour = "black", fill = NA, size = 1), legend.position = "bottom") +
#  geom_raster(data = had_max_yr_sub, aes(x = x, y = y, fill = year), alpha=0.8, interpolate = TRUE) + 
#  scale_fill_distiller("ºC", palette = "Reds", trans = "reverse", limits = c(32, 26)) +
#  geom_polygon(data = land, aes(x = long, y = lat, group = group), fill = "grey70", color='grey39', lwd = 0.1) +
#  guides(fill = guide_colorbar(reverse = TRUE, frame.colour = "black", ticks.colour = "black")) +
#  coord_sf(xlim = c(-90,-59), ylim = c(8,33)) +
...
### Combined max SST and year observed plot
#plot_grid(had_max_subset_plot, had_max_year_subset_plot, labels = c("A", "B")) +
...
##### Pathfinder max temp raster layer

## create raster layer of the max SST per pixel
path_brick <- brick(Pathfinder_monthly_edit_path)
raster_p_max <- max(path_brick, na.rm = TRUE)

## convert the raster of SST to a df for plotting
path_max <- as.data.frame(as(raster_p_max, "SpatialPixelsDataFrame")) # convert to a raster to dataframe
colnames(path_max) <- c("max", "x", "y")


## convert the raster of observational year to a df for plotting
#path_max_yr <- as.data.frame(as(raster_max_yr, "SpatialPixelsDataFrame")) # convert to a raster to dataframe
#colnames(path_max_yr) <- c("year", "x", "y")

```

```{r path max SST map, message=FALSE, warning=FALSE, fig.align='center'}
# , fig.width=12, fig.height=6

### Plot the max SST per pixel (Pathfinder)
path_max_plot <- ggplot() +  
  theme_bw() +
  theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(), panel.background=element_blank(), strip.background = element_blank(), panel.border = element_rect(colour = "black", fill = NA, size = 1), legend.position = "bottom") +
  ...
  ylab("Latitude") +
  xlab("Longitude") +
  ggtitle(paste0("Maximum recorded SST between ", format.Date(start_dateb, "%Y"), " and ", format.Date(end_date, "%Y")," (Pathfinder)")) 
path_max_plot


### Plot the year of the max SST
#path_max_year_subset_plot <- ggplot() +  
#  theme_bw() +
#  theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(), panel.background=element_blank(), strip.background = element_blank(), panel.border = element_rect(colour = "black", fill = NA, size = 1), legend.position = "bottom") +
#  geom_raster(data = path_max_yr_sub, aes(x = x, y = y, fill = year), alpha=0.8, interpolate = TRUE) + 
#  scale_fill_distiller("ºC", palette = "Reds", trans = "reverse", limits = c(32, 26)) +
#  geom_polygon(data = land, aes(x = long, y = lat, group = group), fill = "grey70", color='grey39', lwd = 0.1) +
#  guides(fill = guide_colorbar(reverse = TRUE, frame.colour = "black", ticks.colour = "black")) +
#  coord_sf(xlim = c(-90,-59), ylim = c(8,33)) +
...
### Combined max SST and year observed plot
#plot_grid(path_max_subset_plot, path_max_year_subset_plot, labels = c("A", "B")) +
#  ggsave("figures/Fig11_Pathfinder_maxSST_subset.pdf", width = 14, height = 5)

```

**Figure 10 |** Maximum SST ($^\circ$C) recorded in the subset Pathfinder dataset (`r format.Date(start_date2, "%Y")` - `r format.Date(end_date2, "%Y")`) within each grid (**A**). The year in which each maximum SST was observed is denoted in panel **B**. 
...
## convert the raster of observational year to a df for plotting
#had_min_yr <- as.data.frame(as(raster_min_yr, "SpatialPixelsDataFrame")) # convert to a raster to dataframe
#colnames(had_min_yr) <- c("year", "x", "y")

```

```{r had min SST map, message=FALSE, warning=FALSE, fig.align='center'}
# , fig.width=12, fig.height=6
...
had_min_plot <- ggplot() +  
  ...
  ylab("Latitude") +
  xlab("Longitude") +
  ggtitle(paste0("Minimum recorded SST between ", format.Date(start_date, "%Y"), " and ", format.Date(end_date, "%Y")," (HadISST)")) 
had_min_plot
...
#  theme_bw() +
#  theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(), panel.background=element_blank(), strip.background = element_blank(), panel.border = element_rect(colour = "black", fill = NA, size = 1), legend.position = "bottom") +
#  geom_raster(data = had_min_yr, aes(x = x, y = y, fill = year), alpha=0.8, interpolate = TRUE) + 
#  scale_fill_distiller("ºC", palette = "Reds", trans = "reverse", limits = c(32, 26)) +
#  geom_polygon(data = land, aes(x = long, y = lat, group = group), fill = "grey70", color='grey39', lwd = 0.1) +
#  guides(fill = guide_colorbar(reverse = TRUE, frame.colour = "black", ticks.colour = "black")) +
#  coord_sf(xlim = c(-90,-59), ylim = c(8,33)) +
...
#plot_grid(had_min_plot, had_min_year_plot, labels = c("A", "B")) +
#  ggsave("figures/Fig11_HadISST_minSST.pdf", width = 14, height = 5)

```

**Figure 11 |** Minimum SST ($^\circ$C) recorded in the entire HadISST dataset (from `r format.Date(start_date, "%Y")` to `r format.Date(end_date, "%Y")`) within each grid (**A**). The year in which each minimum SST was observed is denoted in panel **B**. 
...
##### 1981 - 2019 subset HadISST min temp raster layer

## create raster layer of the min SST per pixel
raster_min_sub <- min(data_brickb)
...
## convert the raster of observational year to a df for plotting
#had_min_yr_sub <- as.data.frame(as(raster_min_yr_sub, "SpatialPixelsDataFrame")) # convert to a raster to dataframe
#colnames(had_min_yr_sub) <- c("year", "x", "y")

```

```{r had min subset SST map, message=FALSE, warning=FALSE, fig.align='center'}
# , fig.width=12, fig.height=6
...
had_min_subset_plot <- ggplot() +  
  ...
  ylab("Latitude") +
  xlab("Longitude") +
  ggtitle(paste0("Minimum recorded SST between ", format.Date(start_dateb, "%Y"), " and ", format.Date(end_date, "%Y")," (HadISST)")) 
had_min_subset_plot


### Plot the year of the min SST
#had_min_year_subset_plot <- ggplot() +  
#  theme_bw() +
#  theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(), panel.background=element_blank(), strip.background = element_blank(), panel.border = element_rect(colour = "black", fill = NA, size = 1), legend.position = "bottom") +
#  geom_raster(data = had_min_yr_sub, aes(x = x, y = y, fill = year), alpha=0.8, interpolate = TRUE) + 
#  scale_fill_distiller("ºC", palette = "Reds", trans = "reverse", limits = c(32, 26)) +
#  geom_polygon(data = land, aes(x = long, y = lat, group = group), fill = "grey70", color='grey39', lwd = 0.1) +
#  guides(fill = guide_colorbar(reverse = TRUE, frame.colour = "black", ticks.colour = "black")) +
#  coord_sf(xlim = c(-90,-59), ylim = c(8,33)) +
...
### Combined min SST and year observed plot
#plot_grid(had_min_subset_plot, had_min_year_subset_plot, labels = c("A", "B")) +
#  ggsave("figures/Fig12_HadISST_minSST_subset.pdf", width = 14, height = 5)

```

**Figure 12 |** Minimum SST ($^\circ$C) recorded in the subset HadISST dataset (`r format.Date(start_date, "%Y")` - `r format.Date(end_date, "%Y")`) within each grid (**A**). The year in which each minimum SST was observed is denoted in panel **B**. 


#### Pathfinder (1981 - 2019)

```{r path sub min SST df}
...
```{r path min SST map, message=FALSE, warning=FALSE, fig.align='center'}
# , fig.width=12, fig.height=6
...
path_min_plot <- ggplot() +  
  ...
  ylab("Latitude") +
  xlab("Longitude") +
  ggtitle(paste0("Minimum recorded SST between ", format.Date(start_dateb, "%Y"), " and ", format.Date(end_date, "%Y")," (Pathfinder)")) 
path_min_plot
...
**Figure 13 |** Minimum SST ($^\circ$C) recorded in the Pathfinder dataset (`r format.Date(start_date, "%Y")` - `r format.Date(end_date, "%Y")`) within each grid (**A**). The year in which each minimum SST was observed is denoted in panel **B**. 
